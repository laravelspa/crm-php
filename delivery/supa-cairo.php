<?php
    ...
    if($sessionPermission !== '4') {
        ...
        if(isset($sessionName) && isset($sessionPermission) && isset($sessionId)) {
            $stmt = $con->prepare("SELECT id, name, permission FROM admins WHERE supervisor = $sessionId AND permission = 5 AND location = 0");
            $stmt->execute();
                    ...
                    <div class="tab-pane fade" id="approved" role="tabpanel" aria-labelledby="approve-tab">
                        <table id="approved_orders" class="table table-hover table-bordered table-responsive" style="width:100%">
                            <thead>
                                <tr>
                                    <th class="text-center" style="max-width:10px">
                                        <input type="checkbox" class="checkedAll" id="checkedListapproved" />  
                                    </th>
                                    <th class="text-center" style="min-width: 100px">Type</th>
                                    <th class="text-center" style="min-width: 100px">Approved by me</th>
...
<script src="/js/delivery-supacairo.js"></script>
