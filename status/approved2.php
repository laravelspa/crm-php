...
include('../main/header1.php'); include('../main/database.php');   
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text"><a href="approved.php?pn=all" style="text-decoration: none"
            class="<?php echo $_GET['pn'] === 'all' ? 'font-weight-bold' : ''; ?>">
             All</a></span>
    ...
    <!-- /.col -->
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text"><a href="approved.php?pn=<?php echo $key ?>" style="text-decoration: none"
            class="<?php echo $_GET['pn'] === $key ? 'font-weight-bold' : ''; ?>">
             <?php echo $key ?></a></span>
...
<script>
    ...
    $(document).ready(function() {
        getRecords('fetch_approved2.php')
        ...
        $(document).on('submit', '#filter_approved', function(e) {
            ...
            // if(count===1) {
                ...
                getRecords('fetch_approved2.php',emp_id,'',date_first,date_last,city,shipping,'#table_id',network)
            // }
        })
