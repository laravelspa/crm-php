$(document).ready(function () {
    ...
    $(document).on('submit', '#filter_aramex', function (e) {
        e.preventDefault();
        count++;
        if (count === 1) {
            ...
            if (destination === '#stage') {
                ...
                getRecords('fetch/fetch_stage_leads.php', '#stage_orders', emp_id, date_first, date_last, city);
            } else if (destination === '#new') {
                $('#new_orders').DataTable().destroy();
                getRecords('fetch/fetch_new_leads.php', '#new_orders', emp_id, date_first, date_last, city);
            } else if (destination === '#waiting') {
                $('#waiting_orders').DataTable().destroy();
                getRecords('fetch/fetch_waiting_leads.php', '#waiting_orders', emp_id, date_first, date_last, city);
            } else if (destination === '#ready') {
                $('#ready_orders').DataTable().destroy();
                getRecords('fetch/fetch_ready_leads.php', '#ready_orders', emp_id, date_first, date_last, city);
            } else {
                $('#finish_orders').DataTable().destroy();
                getRecords('fetch/fetch_finish_leads.php', '#finish_orders', emp_id, date_first, date_last, city);
            }
        }
        count = 0;
    })
...
getRecords('fetch/fetch_stage_leads.php', '#stage_orders');
getRecords('fetch/fetch_new_leads.php', '#new_orders');
getRecords('fetch/fetch_waiting_leads.php', '#waiting_orders');
getRecords('fetch/fetch_ready_leads.php', '#ready_orders');
getRecords('fetch/fetch_finish_leads.php', '#finish_orders');
...
$(document).on('click', '#approved_btn', function () {
    ...
    approvedOrder(id, approved, msg, cancelMsg, prname, prpieces, inventory)
})
