$(document).ready(function () {
    ...
    $(document).on('submit', '#filter_alex', function (e) {
        e.preventDefault();
        count++;
        if (count === 1) {
            ...
            if (destination === '#stage') {
                ...
                getRecords('fetch_assistant_alex/fetch_stage_leads.php', '#stage_orders', emp_id, date_first, date_last, city);
            } else if (destination === '#processing') {
                $('#processing_orders').DataTable().destroy();
                getRecords('fetch_assistant_alex/fetch_processing_leads.php', '#processing_orders', emp_id, date_first, date_last, city);
            } else {
                $('#approved_orders').DataTable().destroy();
                getRecords('fetch_assistant_alex/fetch_approved_leads.php', '#approved_orders', emp_id, date_first, date_last, city);
            }
        }
        count = 0;
    })
...
getRecords('fetch_assistant_alex/fetch_stage_leads.php', '#stage_orders');
getRecords('fetch_assistant_alex/fetch_processing_leads.php', '#processing_orders');
getRecords('fetch_assistant_alex/fetch_approved_leads.php', '#approved_orders');
getRecords('fetch_assistant_alex/fetch_finish_leads.php', '#finish_orders');
