    ...
    $(document).on('submit', '#filter_cairo', function (e) {
        ...
        if (count === 1) {
            ...
            if (destination === '#stage') {
                ...
                getRecords('fetch_delivery/fetch_stage_leads.php', '#stage_orders', emp_id, date_first, date_last, city);
            } else if (destination === '#processing') {
                $('#processing_orders').DataTable().destroy();
                getRecords('fetch_delivery/fetch_processing_leads.php', '#processing_orders', emp_id, date_first, date_last, city);
            } else if (destination === '#approved') {
                $('#approved_orders').DataTable().destroy();
                getRecords('fetch_delivery/fetch_approved_leads.php', '#approved_orders', emp_id, date_first, date_last, city);
            } else {
                $('#finish_orders').DataTable().destroy();
                getRecords('fetch_delivery/fetch_finish_leads.php', '#finish_orders', emp_id, date_first, date_last, city);
            }
        }
        count = 0;
    })
...
getRecords('fetch_delivery/fetch_stage_leads.php', '#stage_orders');
getRecords('fetch_delivery/fetch_processing_leads.php', '#processing_orders');
getRecords('fetch_delivery/fetch_approved_leads.php', '#approved_orders');
getRecords('fetch_delivery/fetch_finish_leads.php', '#finish_orders');
