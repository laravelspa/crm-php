      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="index.php" class="nav-link <?php echo $last_part == 'index.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
              <a href="employee.php" class="nav-link <?php echo $last_part == 'employee.php' ? 'active' : ''; ?>">
