...
<div class="card">
    ...
    <div class="card-body">
        <div class="float-right">
            <button type="button" id="deleteAllButton" class="btn btn-outline-danger btn-sm" onclick="deleteAll('delete_lead.php', 'terraleads','Delete this leads','You must be Choose user to delete it. ','you are canceld this deleting operation.')">
        ...
        <div class="table-responsive">   
           <table id="terraleads" class="table table-hover table-bordered table-responsive">
                <thead>
                    <tr>
            ...
            <form id="form_edit_lead">
                <div class="modal-body">
                    ...
                    <div class="form-group p-2">
                        ...
                        <input type="text" id="lead_address" class="form-control" placeholder="address" dir="auto" />
                    </div>
                   
                    <div class="form-group p-2">
                        <label for="lead_country">Country</label>
                        <input type="text" id="lead_country" class="form-control" placeholder="country" dir="auto" required/>
                    </div>
   ...
   <script>
       document.title = 'HealthyCURE | Api';
                ...
                if(checked.length === 0) {
                            ...
                            selected.push(
                                {
                                    ...
                                    country: checked[i].getAttribute("data-country"),  
                                    address: checked[i].getAttribute("data-address"),  
                                    prname: checked[i].getAttribute("data-prn"),
                                    id: checked[i].getAttribute("data-id"),
                                    lead_id: checked[i].getAttribute("data-lid"),
                                    web_id: checked[i].getAttribute("data-wid"),
                                    add_date: checked[i].getAttribute("data-add"),
                                }
                            )
                        }
                    }
                    ...
                    fetch('re_assign.php', {
                        ...
                        if(r.message === true) {
                            ...
                            $('#terraleads').DataTable().ajax.reload();
                        } else {
                            $('#terraleads').DataTable().ajax.reload();
        ...
        $(document).on('click','#edit_lead', function() {
            ...
            $('#lead_address').val(add);
            $('#lead_country').val(country);
